...
public class ProjectController {
    ...
    public List<ProjectResp> findProjectsWithFilters(@RequestBody ProjectFiltersReq projectFiltersReq) {
        return projectService.findProjectsWithFilters(projectFiltersReq);
    }
