...
class InternshipMapperTest {
    private final faang.school.projectservice.mapper.InternshipMapper internshipMapper = Mappers.getMapper(faang.school.projectservice.mapper.InternshipMapper.class);
