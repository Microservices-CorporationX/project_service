...
public class MeetingControllerTest {
    ...
    private static final String UPDATE_URL = "/update/{meetId}";
    private static final String DELETE_URL = "/delete/{projectId}/{currentUserId}/{meetId}";
    ...
    void testCreateMeeting() throws Exception {
        ...
        mockMvc.perform(post(BASE_URL + CREATE_URL)
                ...
                .andExpect(jsonPath("$.description").value("Meeting description"));
    ...
    void testFilterMeetings() throws Exception {
        ...
        String requestJson = objectMapper.writeValueAsString(meetDto);
        mockMvc.perform(post(BASE_URL + FILTER_URL)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(requestJson))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
